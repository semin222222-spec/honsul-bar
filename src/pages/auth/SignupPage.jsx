...
export default function SignupPage() {
  ...
  const validate = () => {
    ...
    if (!/^[a-z0-9-]+$/.test(form.storeSlug))
      return "매장 URL은 영문 소문자, 숫자, '-'만 사용 가능해요";
    return null;
  };
    ...
    return (
      ...
      >
        ...
        >
          <CheckCircle
            size={64}
            style={{ color: "#6AB06A", marginBottom: 20 }}
          />
          <div
            style={{
        ...
        >
          <form onSubmit={handleSubmit}>
            ...
            <FormField
              ...
              onChange={(v) =>
                update("storeSlug", v.toLowerCase().replace(/[^a-z0-9-]/g, ""))
              }
              placeholder="gangnam"
              hint={
                form.storeSlug
                  ? `honsul-bar.com/${form.storeSlug}`
                  : "예: gangnam, hongdae-2"
              }
            />
