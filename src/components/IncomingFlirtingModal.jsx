    ...
    >
      <motion.div
        ...
        style={{
          ...
          background: "linear-gradient(135deg, rgba(60,30,50,0.98), rgba(40,20,40,0.98))",
      ...
      >
        ...
        <div style={{ marginTop: 30 }}>
          ...
          <div style={{
            padding: "16px",
            background: "linear-gradient(135deg, rgba(255,107,157,0.15), rgba(196,122,255,0.08))",
            border: "1px solid rgba(255,107,157,0.3)",
            borderRadius: 14,
            marginBottom: 18,
          }}>
            <div style={{
              fontSize: 9, color: "rgba(255,200,220,0.5)",
          ...
          <div style={{
            ...
            border: "1px solid " + (remainingSeconds <= 10
              ? "rgba(226,75,74,0.3)"
              : "rgba(255,255,255,0.08)"),
            borderRadius: 100,
            marginBottom: 18,
            fontSize: 10,
            color: remainingSeconds <= 10 ? "#FF7878" : "rgba(255,255,255,0.5)",
          }}>
            <motion.span
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <motion.button
              ...
              disabled={responding}
              style={{
                flex: 1.6, padding: 13, borderRadius: 11,
