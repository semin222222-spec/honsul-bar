...
import { getDefaultLayout } from "./FloorPlan";
    ...
    >
      <motion.div
        ...
        style={{
          ...
          background: "linear-gradient(135deg, rgba(40,20,30,0.98), rgba(20,15,25,0.98))",
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: 14 }}>
          ...
          <div style={{
            fontSize: 18, color: "#FF6B9D",
            fontFamily: "'Noto Serif KR', serif", fontWeight: 600,
            marginBottom: 4,
          }}>
            게임 신청할 자리 선택
          </div>
          <div style={{ fontSize: 11, color: "rgba(255,200,220,0.7)", lineHeight: 1.5 }}>
            <span style={{ color: "#FF6B9D", fontWeight: 600 }}>분홍색</span>이 내 자리예요 (📍 {mySeatLabel})<br/>
            <span style={{ color: "#6AB06A", fontWeight: 600 }}>초록색</span> 자리에 게임을 신청할 수 있어요
          </div>
        </div>
        ...
        {rowsLoading ? (
          <div style={{ textAlign: "center", padding: "40px 0" }}>
            <motion.div
              ...
              style={{ display: "inline-block", color: "rgba(255,107,157,0.4)" }}
            >
              <Loader2 size={28} />
            </motion.div>
          ...
          <>
            ...
            <div style={{
              ...
              <Legend color="linear-gradient(135deg, rgba(255,107,157,0.5), rgba(196,122,255,0.3))" border="#FF6B9D" label="내 자리" />
              <Legend color="rgba(106,176,106,0.3)" border="rgba(106,176,106,0.5)" label="신청 가능" />
              <Legend color="rgba(255,255,255,0.03)" border="rgba(255,255,255,0.08)" label="빈자리" />
            </div>
          </>
        )}
        ...
        <AnimatePresence>
          {confirmTarget && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              onClick={(e) => { if (e.target === e.currentTarget && !loading) setConfirmTarget(null); }}
              style={{
            ...
            >
              ...
              >
                ...
                {confirmTarget.nickname && (
                  <div style={{ fontSize: 12, color: "rgba(255,200,220,0.7)", marginBottom: 16 }}>
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  ...
                  <motion.button
                    ...
                    disabled={loading}
                    style={{
                      flex: 1.3, padding: 12, borderRadius: 10,
                      background: loading
...
// ────── 한 줄 (A줄 or B줄) ──────
function SeatPickerRow({ row, rowDirection, sessionMap, mySessionId, onSeatClick }) {
  ...
  return (
    <div style={{ marginBottom: 10 }}>
      <div style={{
        fontSize: 10, color: "rgba(255,107,157,0.5)",
...
function SeatBox({ seat, pos, isMe, isAvailable, isEmpty, onClick }) {
  ...
  if (isMe) {
    style = {
      background: "linear-gradient(135deg, rgba(255,107,157,0.5), rgba(196,122,255,0.25))",
    ...
    style = {
      background: "linear-gradient(135deg, rgba(106,176,106,0.25), rgba(60,120,60,0.12))",
  ...
  return (
    <motion.div
      ...
      animate={
        isMe
          ? { boxShadow: ["0 0 15px rgba(255,107,157,0.5)", "0 0 25px rgba(255,107,157,0.8)", "0 0 15px rgba(255,107,157,0.5)"] }
          : isAvailable
          ? { scale: [1, 1.04, 1] }
          : {}
      }
