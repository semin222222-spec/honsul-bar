...
/**
 * CallMyNameLobby — 방 목록 + 방 만들기 (매장 스코프, 방코드 없음)
 *  라이어/드립 로비와 동일한 발견 방식.
 */
export default function CallMyNameLobby({
  rooms = [],
  loading,
  onCreate,
  onJoin,
  ...
  return (
    <div
      style={{
        ...
        backgroundImage:
          "radial-gradient(ellipse 80% 50% at 20% 10%, rgba(91,229,224,0.08), transparent), radial-gradient(ellipse 60% 40% at 80% 90%, rgba(255,107,53,0.05), transparent)",
      }}
    >
      {/* 헤더 */}
      <div style={{ textAlign: "center", padding: "8px 0 18px" }}>
        ...
        <div
          style={{
            ...
            lineHeight: 1,
            background: `linear-gradient(135deg, ${C.cyanSoft}, ${C.blueDeep})`,
        ...
        <div style={{ fontSize: 12, color: C.sub }}>
          {MIN_PLAYERS}~{MAX_PLAYERS}명 · Yes/No 추리 게임
        </div>
      </div>
      ...
      <Motion.button
        ...
        style={{
          ...
          gap: 8,
          boxShadow: `0 10px 30px -10px ${C.cyanGlow}, inset 0 1px 0 rgba(255,255,255,0.3)`,
          fontFamily: "inherit",
          ...
          {openRooms.map((r) => {
            ...
            return (
              <Motion.div
                ...
                style={{
                  background: `linear-gradient(135deg, ${C.bgCard}, rgba(91,229,224,0.05))`,
                  border: `1px solid rgba(91,229,224,0.25)`,
                  borderRadius: 14,
                  padding: "12px 14px",
                  display: "flex",
                  alignItems: "center",
              ...
              >
                ...
                <span
                  style={{
                    ...
                    padding: "8px 12px",
                    borderRadius: 10,
                    background: full ? "rgba(255,255,255,0.06)" : C.cyan,
                    color: full ? C.muted : "#002a26",
                    fontSize: 12,
                    fontWeight: 800,
                    whiteSpace: "nowrap",
                  }}
      ...
      <div
        style={{
          marginTop: 22,
          padding: "12px 14px",
          background: "rgba(91,229,224,0.06)",
