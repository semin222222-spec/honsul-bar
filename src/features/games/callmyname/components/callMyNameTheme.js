/**
 * 콜 마이 네임 디자인 토큰 (시안 call_my_name_ui.html 기준)
 *
 * 베이스: 블루블랙 / 메인 포인트: 시안(#5BE5E0) → 블루 (추리·미스터리) / 위험·실패: 빨강
 * 한글은 Pretendard, 영문·숫자 디스플레이는 Bebas Neue, 숫자 mono는 Space Mono.
 *
 * 자리 구분 색은 드립/라이어와 동일한 팔레트를 쓴다 (술 취해도 자리색이 게임마다
 * 안 바뀌도록 — 시안 mockup 디자인 노트의 "참가자 색상 다른 게임과 동일"과 일치).
 */
...
// 자리 구분 색 8종 (드립/라이어와 동일 — 핑크/보라 제외)
