...
/**
 * ExposedLobby — 방 목록 + 방 만들기 (매장 스코프, 방코드 없음)
 *  드립/라이어 로비와 동일한 발견 방식.
 */
export default function ExposedLobby({
  rooms = [],
  loading,
  onCreate,
  onJoin,
  ...
  return (
    <div
      style={{
        ...
        backgroundImage:
          "radial-gradient(ellipse 80% 50% at 20% 10%, rgba(255,42,122,0.08), transparent), radial-gradient(ellipse 60% 40% at 80% 90%, rgba(157,78,255,0.05), transparent)",
      }}
    >
      {/* 헤더 */}
      <div style={{ textAlign: "center", padding: "8px 0 18px" }}>
        ...
        <div
          style={{
            ...
            lineHeight: 1,
            background: `linear-gradient(135deg, ${C.pinkSoft}, ${C.purpleDeep})`,
        ...
        <div style={{ fontSize: 12, color: C.sub }}>
          {MIN_PLAYERS}~{MAX_PLAYERS}명 · 다수결이 진실, 소수가 거짓말
        </div>
      </div>
      ...
      <Motion.button
        ...
        style={{
          ...
          gap: 8,
          boxShadow: `0 10px 30px -10px ${C.pinkGlow}, inset 0 1px 0 rgba(255,255,255,0.2)`,
          fontFamily: "inherit",
          ...
          {openRooms.map((r) => {
            ...
            return (
              <Motion.div
                ...
                style={{
                  background: `linear-gradient(135deg, ${C.bgCard}, rgba(255,42,122,0.05))`,
              ...
              >
                ...
                <span
                  style={{
                    ...
                    padding: "8px 12px",
                    borderRadius: 10,
                    background: full ? "rgba(255,255,255,0.06)" : C.pink,
                    color: full ? C.muted : "#fff",
                    fontSize: 12,
                    fontWeight: 800,
                    whiteSpace: "nowrap",
                  }}
