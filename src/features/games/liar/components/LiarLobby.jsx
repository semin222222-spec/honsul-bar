...
import { MAX_PLAYERS, MIN_PLAYERS } from "../lib/liarRules";
 ...
 * LiarLobby — 1단계 로비
 */
export default function LiarLobby({
  rooms,
  loading,
  onCreate,
  onJoin,
  ...
  const inGameRooms = rooms.filter((r) =>
    ["word_reveal", "speech", "voting"].includes(r.status),
  );
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "20px 20px 8px" }}>
        ...
        >
          한 명만 라이어 · 라이어는 정답 단어를 모릅니다 · {MIN_PLAYERS}~
          {MAX_PLAYERS}명
        </div>
      </div>
      ...
      <div style={{ padding: "8px 20px" }}>
        <div
          style={{
            ...
            gap: 10,
            padding: "10px 14px",
            background: "rgba(157,122,224,0.08)",
        ...
        >
          ...
          <span>
            <strong>라이어를 잡아라!</strong>
            <span style={{ color: "rgba(220,200,255,0.7)" }}>
              {" "}
              · 못 잡으면 시민 모두 데킬라 🥃
            </span>
          </span>
      ...
      <div style={{ padding: "12px 20px" }}>
        <Motion.button
          ...
          style={{
            ...
            boxShadow: "0 8px 22px rgba(157,122,224,0.35)",
...
function RoomCard({ room, onJoin, disabled, mySeat }) {
  ...
  return (
    <Motion.div
      ...
      style={{
        background: imIn
          ? "linear-gradient(135deg, rgba(157,122,224,0.15), rgba(157,122,224,0.04))"
          : COLORS.bgCard,
        border: imIn
          ? "1px solid rgba(157,122,224,0.45)"
    ...
    >
      ...
      >
        ...
        <div
          style={{
            fontSize: 11,
            color: full ? COLORS.liar : COLORS.citizen,
            fontWeight: 600,
            display: "inline-flex",
            alignItems: "center",
            gap: 3,
        ...
        {players.map((p) => (
          <span
            ...
            style={{
              ...
              background:
                p.seat_label === mySeat
                  ? "rgba(157,122,224,0.2)"
                  : "rgba(240,232,216,0.08)",
              color: p.seat_label === mySeat ? COLORS.liarBright : "inherit",
            }}
          >
            {p.seat_label}
          </span>
