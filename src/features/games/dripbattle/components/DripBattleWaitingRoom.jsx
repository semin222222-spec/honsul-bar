...
import { MAX_PLAYERS, MIN_PLAYERS, TOTAL_ROUNDS } from "../lib/dripBattleRules";

/**
 * DripBattleWaitingRoom — 대기실 (시안 화면 1)
 *  방코드 대신 매장 로비 방식. 자리 번호 아바타로 참가자 표시.
 */
export default function DripBattleWaitingRoom({
  room,
  isHost,
  sessionId,
  onLeave,
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: 11, color: C.gold, marginTop: 2 }}>
          총 {room.total_rounds || TOTAL_ROUNDS}라운드 진행
        </div>
      </div>
        ...
        {isHost ? (
          <Motion.button
            ...
            style={{
              ...
              color: canStart && !starting ? "#1a0f00" : C.muted,
              fontWeight: 900,
              fontSize: 16,
