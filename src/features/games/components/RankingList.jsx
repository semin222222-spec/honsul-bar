...
export default function RankingList() {
  ...
  const fetchRankings = useCallback(async () => {
    ...
    setLoading(true);
    const data = await gameRepository.listTopRankings({ storeId, limit: 5 });
    setRankings(data);
    setLoading(false);
  }, [storeId]);
  ...
  useEffect(() => {
    ...
    const unsubscribe = gameRepository.subscribeToRankings({
      storeId,
      onInsert: () => fetchRankings(),
      onStatus: (status) => {
        handleRealtimeSubscribeStatus(status, {
          label: "Rankings",
          onSubscribed: fetchRankings,
          onRecoverable: fetchRankings,
        });
      },
    });
              ...
              >
                <div
                  style={{
                    ...
                    color: rs.color,
                    background:
                      i < 3 ? "transparent" : "rgba(255,255,255,0.04)",
                  }}
                >
                  {rs.emoji}
                </div>
