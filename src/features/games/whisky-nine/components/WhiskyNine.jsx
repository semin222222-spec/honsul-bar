...
import RankingList from "@/features/games/components/RankingList";
...
function HiddenCard({ size = "reveal" }) {
  const s =
    size === "reveal" ? { w: 62, h: 80 } : { w: "100%", aspectRatio: "2/2.8" };
  return (
    <div
      style={{
        width: s.w,
...
export default function WhiskyNine({
  ...
  if (!opponentReady) {
    return (
      <div
        style={{ padding: "clamp(24px, 6vw, 40px) 20px", textAlign: "center" }}
      >
        <Motion.div
  ...
  if (phase === "gameover") {
    const myFinal =
      myWins > oppWins
        ? { emoji: "👑", text: "승리", cls: "#6AB06A" }
        : myWins < oppWins
          ? { emoji: "🥀", text: "패배", cls: "#E24B4A" }
  ...
  return (
    ...
    >
        ...
        {showUpset && (
          <Motion.div
            ...
            style={{
              ...
              zIndex: 50,
              background:
                "radial-gradient(circle at center, rgba(212,165,55,0.3), transparent 60%)",
              pointerEvents: "none",
            }}
          />
        )}
          ...
          <Motion.div
            ...
            animate={
              d === "current"
                ? {
                    boxShadow: [
                      "0 0 0px rgba(212,165,55,0)",
                      "0 0 10px rgba(212,165,55,0.6)",
                      "0 0 0px rgba(212,165,55,0)",
                    ],
                  }
                : {}
            ...
            <span style={{ display: "flex", alignItems: "center", gap: 3 }}>
              <span
                style={{
                  ...
                  background:
                    "radial-gradient(circle at 30% 30%, #3a3128, #0a0604)",
                }}
              />
              {oppBlackCount}
            </span>
            <span style={{ display: "flex", alignItems: "center", gap: 3 }}>
              <span
                style={{
                  ...
                  border: "1px solid rgba(212,165,55,0.3)",
                  background:
                    "radial-gradient(circle at 30% 30%, #f5ebd2, #b8a27a)",
                }}
              />
              {oppWhiteCount}
            </span>
      ...
      >
        ...
        >
          ROUND <span style={{ color: "#D4A537", fontSize: 15 }}>{round}</span>{" "}
          / 9
        </div>
            ...
            >
              ...
              {isUpset(lastMy.num, lastOpp.num) && (
                <Motion.span
                  animate={{
                    boxShadow: [
                      "0 0 6px rgba(212,165,55,0.3)",
                      "0 0 16px rgba(212,165,55,0.6)",
                      "0 0 6px rgba(212,165,55,0.3)",
                    ],
                  }}
      ...
      <div
        style={{
          background:
            "linear-gradient(135deg, rgba(212,165,55,0.06), rgba(180,120,30,0.03))",
          border: "1px solid rgba(212,165,55,0.25)",
          borderRadius: 14,
          padding: "10px 12px",
          marginBottom: 10,
