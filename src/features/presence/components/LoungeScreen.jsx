  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            {locale === "ja" ? (
              ...
              <>
                🌙 지금 <strong>혼자이고 싶음</strong> 상태라 상대에게 신청할 수
                없어요.
                <br />
                <span style={{ color: "rgba(255,255,255,0.4)", fontSize: 11 }}>
                  시그널 탭에서 상태를 바꿔주세요.
          ...
          return (
            <button
              ...
              style={{
                ...
                border:
                  "1px solid " +
                  (active ? "rgba(212,165,55,0.35)" : "rgba(255,255,255,0.06)"),
                background: active
      ...
      >
        ...
        >
          💡 <strong style={{ color: "rgba(212,165,55,0.8)" }}>더 나인</strong>
          은 1~9 카드로 겨루는 9라운드 심리 게임이에요. 단,{" "}
