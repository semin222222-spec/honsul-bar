    ...
    <div>
      ...
      <Motion.div
        ...
        style={{
          padding: 18,
          background:
            "linear-gradient(135deg, rgba(212,165,55,0.15), rgba(180,120,30,0.04))",
        ...
        {yesterdayRevenue > 0 ? (
          <div
            style={{
              fontSize: 11,
              color:
                revenueChangePct >= 0 ? "#6AB06A" : "rgba(255,150,150,0.85)",
              fontWeight: 500,
            }}
          >
            {revenueChangePct >= 0 ? "▲" : "▼"} 어제 대비{" "}
      ...
      {onShowHistory && (
        <Motion.button
          ...
          style={{
            ...
            padding: "14px 16px",
            background:
              "linear-gradient(135deg, rgba(196,122,255,0.08), rgba(140,80,200,0.03))",
      ...
      >
        💡 <strong>안내</strong>
        <br />
        · 통계는 새 주문이 생기면 자동 갱신됩니다
        <br />· 주간/월간 차트는 데이터가 더 쌓이면 추가될 예정이에요
      </div>
    </div>
  );
}
