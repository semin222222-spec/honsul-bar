...
function DrinkDetail({
  ...
  return (
    <Motion.div
      ...
      onClick={(e) => {
        if (e.target === e.currentTarget && !ordering) onClose();
      }}
    >
      <Motion.div
          ...
          >
            ...
            <div
              style={{
                ...
                height: 60,
                background:
                  "linear-gradient(180deg, transparent, rgba(20,18,14,1))",
                pointerEvents: "none",
              }}
            />
          </div>
            ...
            >
              {drink.abv && (
                ...
                >
                  ...
                  <span
                    style={{ fontSize: 15, fontWeight: 500, color: "#F5E6C8" }}
                  >
                    {drink.abv}
                  </span>
                </div>
                    ...
                    >
                      <div
                        style={{
                          ...
                          border:
                            "2px solid " +
                            (isSelected ? lineColor : "rgba(255,255,255,0.2)"),
                          position: "relative",
                          flexShrink: 0,
                        }}
                      >
            ...
            >
              ...
              <Motion.button
                ...
                style={{
                  ...
                  color: lineColor,
                  cursor:
                    ordering || quantity >= 10 ? "not-allowed" : "pointer",
    ...
    >
      <Motion.div
        ...
        style={{
          ...
          maxWidth: 340,
          background:
            "linear-gradient(135deg, rgba(30,40,30,0.98), rgba(15,25,15,0.98))",
          backdropFilter: "blur(24px)",
          borderRadius: 20,
      ...
      >
        ...
        <Motion.div
          ...
          style={{
            ...
            borderRadius: "50%",
            background:
              "linear-gradient(135deg, rgba(106,176,106,0.25), rgba(60,120,60,0.15))",
      ...
      >
        ...
        <Motion.button
          ...
          style={{
            ...
            border:
              "1px solid " +
              (copiedField === "ssid" ? "transparent" : "rgba(212,165,55,0.2)"),
            borderRadius: 5,
...
export default function MenuScreen({
  ...
  const menuSections = categories.map((cat) => {
    const items = menus
      ...
      .map((m) => {
        ...
        const minPrice = hasOpts
          ? Math.min(...opts.map((o) => o.price))
          : m.price;
    ...
    const fallback = colorMap[cat.name] || {
      color: "#D4A537",
      bg: "rgba(212,165,55,0.06)",
      border: "rgba(212,165,55,0.15)",
    };
  ...
  useEffect(() => {
    if (firstCategoryId && !activeCategoryId) {
                    ...
                    {group.items.map((item) => (
                      <Motion.div
                        ...
                        style={{
                          ...
                          gap: "clamp(10px, 3vw, 14px)",
                          padding:
                            "clamp(10px, 3vw, 13px) clamp(12px, 3.5vw, 14px)",
                          background: "rgba(255,255,255,0.02)",
                          border: "1px solid rgba(255,255,255,0.05)",
