...
import { useSOSSend } from "@/features/sos/hooks/useSOSSignals";
...
const SOS_OPTIONS = [
  {
    ...
    desc: "사장님이 자연스럽게 대화를 연결해 드릴게요",
  },
  {
    id: "menu_recommend",
    label: "메뉴 추천 필요해요",
    icon: <Wine size={20} />,
    desc: "취향에 맞는 술을 추천받아 보세요",
  },
  {
    id: "seat_uncomfortable",
    label: "자리가 불편해요",
    icon: <Coffee size={20} />,
    desc: "더 편한 자리로 안내해 드릴게요",
  },
  {
    id: "want_quiet",
    label: "조용히 쉬고 싶어요",
    icon: <Moon size={20} />,
    desc: "방해받지 않도록 배려해 드릴게요",
  },
];
...
export default function SOSModal({
  ...
  const { sendSOS, sending } = useSOSSend(storeId);
            ...
            <AnimatePresence mode="wait">
              ...
              {phase === "error" && (
                ...
                >
                  <AlertCircle
                    size={42}
                    style={{ color: "rgba(220,100,100,0.7)", marginBottom: 12 }}
                  />
                  <div
                    style={{
                      fontSize: 15,
              ...
              {phase === "select" && (
                ...
                >
                  ...
                  >
                    📍 내 자리:{" "}
                    <span
                      style={{ color: "rgba(212,165,55,0.6)", fontWeight: 500 }}
                    >
                      {seatLabel}
                    </span>
                  </div>
