...
function IngredientCard({
      ...
      >
        ...
        >
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              비활성 · {CATEGORY_LABEL[ing.category]} · 재고 {ing.current_stock}
              ml
            </div>
          </div>
          <button
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: 14, color: "#F5E6C8", fontWeight: 500 }}>
            {ing.name}
          </div>
          <div
            style={{
      ...
      >
        <Motion.div
          ...
          style={{
            height: "100%",
            background: critical
              ? "linear-gradient(90deg, #FF5050, #CC2020)"
              : low
                ? "linear-gradient(90deg, #E24B4A, #B03838)"
      ...
      <div style={{ display: "flex", gap: 6 }}>
        ...
        <Motion.button
          ...
          style={{
            ...
            borderRadius: 8,
            background:
              "linear-gradient(135deg, rgba(212,165,55,0.18), rgba(180,120,30,0.08))",
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: 12 }}>
          ...
          >
            일본어{" "}
            <span style={{ color: "rgba(255,255,255,0.3)" }}>(선택)</span>
          </div>
          <input
            type="text"
            value={nameJa}
            ...
            style={{
              ...
              background:
                submitting || !name.trim()
                  ? "rgba(212,165,55,0.3)"
                  : "linear-gradient(135deg, #D4A537, #B8861F)",
              border: "none",
              borderRadius: 10,
              color: "#0D0B08",
              fontSize: 13,
    ...
    >
      <Motion.div
        ...
        style={{
          ...
          border:
            "1px solid " +
            (inUse ? "rgba(212,165,55,0.25)" : "rgba(226,75,74,0.3)"),
          borderRadius: 16,
          padding: 20,
        }}
      >
        ...
        <div
          style={{
            ...
            border:
              "1px solid " +
              (inUse ? "rgba(212,165,55,0.15)" : "rgba(226,75,74,0.2)"),
            borderRadius: 10,
          }}
        >
          ...
          {inUse ? (
            <>
              ...
              >
                {usage.recipeCount > 0 && (
                  <li>📋 메뉴 레시피 {usage.recipeCount}개</li>
                )}
                {usage.movementCount > 0 && (
                  <li>📊 입출고 이력 {usage.movementCount}건</li>
                )}
              </ul>
              <div
                style={{
                  ...
                  borderRadius: 8,
                  fontSize: 11,
                  color: "rgba(212,165,55,0.9)",
                  lineHeight: 1.6,
                }}
              >
                📌 <strong>비활성화만 됩니다.</strong>
                <br />
                목록에서 숨겨지지만 데이터는 안전하게 보존되어 나중에 복원할 수
                있어요.
              </div>
            </>
          ) : (
      ...
      >
        ...
        <div style={{ fontSize: 12 }}>
          ...
          >
            ...
            <span style={{ color: "#F5E6C8", fontWeight: 500 }}>
              {ing.current_stock.toLocaleString()}ml
            </span>
          </div>
          <div
            style={{
      ...
      >
        ...
        <div style={{ marginBottom: 12 }}>
          ...
          <div style={{ display: "flex", gap: 6 }}>
            {[-100, -50, -10, +10, +50, +100].map((v) => (
              <button
                key={v}
                onClick={() => setDelta(delta + v)}
                style={{
                  flex: 1,
                  padding: 8,
                  background:
                    v < 0 ? "rgba(226,75,74,0.08)" : "rgba(106,176,106,0.08)",
                  border:
                    "1px solid " +
                    (v < 0 ? "rgba(226,75,74,0.2)" : "rgba(106,176,106,0.2)"),
                  borderRadius: 7,
                  color: v < 0 ? "#E87A79" : "#6AB06A",
                  fontSize: 11,
                  fontWeight: 600,
                  cursor: "pointer",
                  fontFamily: "inherit",
        ...
        >
          ...
          >
            {delta > 0 ? "+" : ""}
            {delta}
            <span style={{ fontSize: 13, marginLeft: 2 }}>ml</span>
          </div>
          <div
            style={{
              fontSize: 10,
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <Motion.button
            ...
            style={{
              ...
              padding: 12,
              background:
                submitting || delta === 0 || !reason.trim()
                  ? "rgba(196,122,255,0.3)"
                  : "linear-gradient(135deg, #C47AFF, #9540D9)",
              border: "none",
              borderRadius: 10,
              color: "#fff",
              fontSize: 13,
...
function MovementItem({ m }) {
  ...
  const isAdjust =
    m.movement_type === "adjust_in" || m.movement_type === "adjust_out";
...
export default function InventoryAdminPanel({ storeId }) {
  ...
  const activeIngredients = filteredIngredients.filter(
    (i) => i.is_active !== false,
  );
  const inactiveIngredients = filteredIngredients.filter(
    (i) => i.is_active === false,
  );
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              background:
                subTab === t.key ? "rgba(212,165,55,0.15)" : "transparent",
                ...
                <AnimatePresence>
                  {lowStockIngs.map((ing) => (
                    <IngredientCard
                      ...
                      onEdit={(i) =>
                        setFormTarget({ mode: "edit", initial: i })
                      }
                ...
                >
                  <span
                    style={{
                      fontSize: 10,
                      letterSpacing: "0.15em",
                      color: "rgba(196,122,255,0.6)",
                      fontWeight: 600,
                      textTransform: "uppercase",
                      fontFamily: "'Noto Serif KR', serif",
                    }}
                  >
                    📦 보관함 ({inactiveIngredients.length})
                  </span>
                  <div
                    style={{
                      flex: 1,
          ...
          >
            <div
              style={{
                ...
                marginBottom: 14,
                background:
                  "linear-gradient(135deg, rgba(212,165,55,0.06), rgba(180,120,30,0.02))",
                border: "1px solid rgba(212,165,55,0.15)",
                borderRadius: 12,
              }}
            >
            ...
            {activeIngredients.map((ing) => (
              ...
              >
                <div style={{ textAlign: "left", flex: 1, minWidth: 0 }}>
                  <div
                    style={{ fontSize: 13, color: "#F5E6C8", fontWeight: 500 }}
                  >
                    {ing.name}
                  </div>
                  <div
                  ...
                  >
                    {CATEGORY_LABEL[ing.category]} · {ing.bottle_size}ml/병 ·
                    현재 {ing.current_stock}ml
                  </div>
                </div>
                <div
                  style={{
                ...
                {groupedMovements.today.length > 0 && (
                  <>
                    ...
                    >
                      ...
                      >
                        {groupedMovements.today.length}건
                      </span>
                    </div>
                    {groupedMovements.today.map((m) => (
                  ...
                  <>
                    ...
                    >
                      ...
                      <span
                        style={{ fontSize: 10, color: "rgba(255,255,255,0.3)" }}
                      >
                        {groupedMovements.yesterday.length}건
                      </span>
                    </div>
                    {groupedMovements.yesterday.map((m) => (
                      <MovementItem key={m.id} m={m} />
                    ))}
                  </>
                )}
                  ...
                  <>
                    ...
                    >
                      ...
                      <span
                        style={{ fontSize: 10, color: "rgba(255,255,255,0.3)" }}
                      >
                        {groupedMovements.older.length}건
                      </span>
                    </div>
                    {groupedMovements.older.map((m) => (
                      <MovementItem key={m.id} m={m} />
                    ))}
                  </>
                )}
